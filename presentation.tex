...
\begin{itemize}
\item Raw prices (original closing prices)
\item Percentage change (fractional change between current and prior element)
\end{itemize}
\end{frame}

\begin{frame}{Why Percentage Change Transformation?}
\textbf{Motivation:}
\begin{itemize}
...
\textbf{Comparison:}
\begin{itemize}
\item \textbf{Raw prices:} Test models on absolute price prediction
\item \textbf{Percentage change:} Test models on return prediction
\end{itemize}

\vspace{1em}

\begin{block}{Research Question}
Do foundation models perform better on raw prices or percentage changes compared to traditional methods?
\end{block}
\end{frame}
